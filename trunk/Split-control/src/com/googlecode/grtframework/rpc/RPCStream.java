...
/**
 * 
 * RPCConnection implementation using streams
 * 
 * @author ajc
 * 
 */
public class RPCStream extends Thread implements RPCConnection {
	...
	public RPCStream(InputStream in, OutputStream out) {
		this.in = in;
		this.out = out;
	}
