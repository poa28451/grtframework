...
import com.grt192.controller.partybot.*;
import com.grt192.mechanism.partybot.*;
import com.grt192.sensor.*;
import com.grt192.actuator.*;
import com.grt192.controller.*;
import com.grt192.controller.teleop.DriveEventController;
...
public class MainRobot extends SimpleRobot {
    ...
    public MainRobot(){
        ...
        armBeta = new ArmBeta(new GRTGPIORelay(7,8));
        armAlpha = new ArmAlpha(new GRTGPIORelay(3,4),
                                new GRTGPIORelay(5,6),
                                new GRTVictor(4),
                                new GRTGyro(1,50),
                                new GRTSwitch(1,25, ""),
                                new GRTSwitch(2,25, ""),
                                new GRTPotentiometer(1, 25));
        driveControl = new DriveEventController(rb, ds);
