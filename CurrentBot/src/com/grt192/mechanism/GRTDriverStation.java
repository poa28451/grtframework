...
public class GRTDriverStation extends Mechanism {
	...
	public void refreshLCD(){
		lcd.println(DriverStationLCD.Line.kMain6, 0, lines[0]);
		lcd.println(DriverStationLCD.Line.kUser2, 0, lines[1]);
		lcd.println(DriverStationLCD.Line.kUser3, 0, lines[2]);
		lcd.println(DriverStationLCD.Line.kUser4, 0, lines[3]);
		lcd.println(DriverStationLCD.Line.kUser5, 0, lines[4]);
		lcd.println(DriverStationLCD.Line.kUser6, 0, lines[5]);
		lcd.updateLCD();
	}
